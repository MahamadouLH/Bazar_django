    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adress_line_2', models.CharField(blank=True, max_length=128)),
                ('country', models.CharField(max_length=128)),
                ('state', models.CharField(max_length=128)),
                ('city', models.CharField(max_length=128)),
                ('order_note', models.TextField(blank=True, max_length=128)),
                ('order_total', models.FloatField()),
                ('tax', models.FloatField()),
                ('status', models.CharField(choices=[('New', 'New'), ('Accepted', 'Accepted'), ('Completed', 'Completed'), ('Cancelled', 'Cancelled')], default='New', max_length=128)),
