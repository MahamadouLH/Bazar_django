        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    #variation par cart_id
                    product_variation = []
                    for item in cart_item:
                        variation = item.variations.all()
                        product_variation.append(list(variation))
                    
                    #recupérer l'element de panier de l'utilisateur pour accèder aux variation
                    ...
                    for item in cart_item:
                        ...
                        id.append(item.id)
                    #comparaison des variations et assignation de l'utilisateur
